...
export const SearchPage = () => {
  ...
  {/* Search Info */ }
  {
    searchInfo && results.length > 0 && (
      <div svg xmlns="http://www.w3.org/2000/svg" className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
      </svg mb - 6 text - sm text - base - content / 70">
          ...
          <div className="card-body">
            <div className="flex items-start justify-between gap-4">
              <div className="flex-1">
                ...
                </divsvg xmlns="http://www.w3.org/2000/svg" className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
{/* No svg xmlns="http://www.w3.org/2000/svg" className="w-16 h-16 text-base-content/30 mb-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
              </svg
        {!loading && results.length === 0 && searchInfo && (
          <div className="card bg-base-100 shadow-xl">
            <div className="card-body items-center text-center py-12">
              <MagnifyingGlassIcon className="w-16 h-16 text-base-content/30 mb-4" />
        ...
        {/* Empty State */}
{
  !loading && !searchInfo && !error && (
    <div className="card bg-base-100 shadow-xl">
      <div className="card-body items-center text-center py-12">
        <MagnifyingGlassIcon className="w-16 h-16 text-primary/30 mb-4" />
