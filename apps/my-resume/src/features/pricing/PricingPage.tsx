        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
                ...
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    ...
                    <code className="text-sm bg-base-200 px-2 py-1 rounded">
                      {getDisplayBaseDomain()}/resume/yourname
                    </code>
                  </span>
                </li>
                <li className="flex items-start gap-2">
          ...
          <div className="card bg-primary text-primary-content shadow-2xl border-4 border-primary relative">
            <div className="absolute -top-4 left-1/2 -translate-x-1/2">
              <span className="badge badge-secondary badge-lg font-bold px-6 py-4">
                MOST POPULAR
              </span>
            </div>
            <div className="card-body">
              ...
              <ul className="space-y-3 mb-6">
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    ...
                    <code className="text-sm bg-primary-content/20 px-2 py-1 rounded">
                      yourname.{getDisplayBaseDomain()}
                    </code>
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-warning text-xl">★</span>
                  <span>
                    <strong>Advanced Analytics:</strong> Visitor tracking,
                    referral sources, session duration
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-warning text-xl">★</span>
          ...
          <div className="space-y-4">
            <div className="collapse collapse-plus bg-base-200">
              ...
              <div className="collapse-content">
                <p>
                  Absolutely! Start with our FREE tier and upgrade to PRO
                  whenever you're ready. Your content and settings will be
                  preserved.
                </p>
              </div>
            </div>
            ...
            <div className="collapse collapse-plus bg-base-200">
              ...
              <div className="collapse-content">
                <p>
                  With PRO, you get your own subdomain like{' '}
                  <code>yourname.{getDisplayBaseDomain()}</code>. This gives you
                  a professional, memorable URL to share with recruiters and on
            ...
            <div className="collapse collapse-plus bg-base-200">
              ...
              <div className="collapse-content">
                <p>
                  PRO tier includes detailed analytics: total views, unique
                  visitors, referral sources (LinkedIn, Indeed, direct links),
                  visitor location, session duration, and daily/weekly trends.
                </p>
              </div>
            </div>
            ...
            <div className="collapse collapse-plus bg-base-200">
              ...
              <div className="collapse-content">
                <p>
                  ...
                  keep PRO features until the end of your billing period, then
            ...
            <div className="collapse collapse-plus bg-base-200">
              ...
              <div className="collapse-content">
                <p>
                  Absolutely. We use industry-standard encryption, secure
                  authentication, and never sell your data. You have full
                  control over your resume's visibility.
                </p>
              </div>
            </div>
          </div>
